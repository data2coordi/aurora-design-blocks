...
?>
        ...
        指定投稿の表示用サムネイルHTMLを出力する。投稿ID（省略時は現在の投稿）アイキャッチ画像のサイズ（デフォルト: 'medium'）デフォルト画像のURL（空なら /assets/default.webp）指定投稿の表示用サムネイルHTMLを出力する。投稿ID（省略時は現在の投稿）アイキャッチ画像のサイズ（デフォルト: 'medium'）デフォルト画像のURL（空なら /assets/default.webp）指定投稿の表示用サムネイルHTMLを出力する。投稿ID（省略時は現在の投稿）アイキャッチ画像のサイズ（デフォルト: 'medium'）デフォルト画像のURL（空なら /assets/default.webp）指定投稿の表示用サムネイルHTMLを出力する。投稿ID（省略時は現在の投稿）アイキャッチ画像のサイズ（デフォルト: 'medium'）デフォルト画像のURL（空なら /assets/default.webp）指定投稿の表示用サムネイルHTMLを出力する。投稿ID（省略時は現在の投稿）アイキャッチ画像のサイズ（デフォルト: 'medium'）デフォルト画像のURL（空なら /assets/default.webp）指定投稿の表示用サムネイルHTMLを出力する。投稿ID（省略時は現在の投稿）アイキャッチ画像のサイズ（デフォルト: 'medium'）デフォルト画像のURL（空なら /assets/default.webp）<?php
